	...
	public function create() {
		...
		if ($this->input->post ( 'subject' ) != "" || $this->input->post ( 'body' ) != "") {
			...
			if ($this->form_validation->run () === TRUE) {
				...
				$actualRecipientCount = $this->_doBatchMail ( $subject, $title, $body, $committeeOnly );
				
				$this->batch_mails_model->insert ( $subject, $title, $body, $committeeOnly, $actualRecipientCount, $senderEmail );
