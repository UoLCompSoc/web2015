			...
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<label for="reg_fullnameone" class="sr-only">Full Name</label> <input type="text" name="reg_fullnameone"
						...
						value="<?php echo set_value('reg_fullnameone');?>"><br> <label for="reg_emailone" class="sr-only">E-Mail Address</label>
					<input type="text" name="reg_emailone" id="reg_emailone" class="form-control" placeholder="E-Mail Address"
						value="<?php echo set_value('reg_emailone'); ?>"><br>
					...
					<label for="reg_fullnametwo" class="sr-only">Full Name</label> <input type="text" name="reg_fullnametwo"
						...
						value="<?php echo set_value('reg_fullnametwo');?>"><br> <label for="reg_emailtwo" class="sr-only">E-Mail Address</label>
					<input type="text" name="reg_emailtwo" id="reg_emailtwo" class="form-control" placeholder="E-Mail Address"
						value="<?php echo set_value('reg_emailtwo'); ?>"><br>
					...
					<label for="reg_fullnamethree" class="sr-only">Full Name</label> <input type="text" name="reg_fullnamethree"
						...
						value="<?php echo set_value('reg_fullnamethree');?>"><br> <label for="reg_emailthree" class="sr-only">E-Mail
						Address</label> <input type="text" name="reg_emailthree" id="reg_emailthree" class="form-control"
						placeholder="E-Mail Address" value="<?php echo set_value('reg_emailthree'); ?>"><br>
					...
					<label for="reg_fullnamefour" class="sr-only">Full Name</label> <input type="text" name="reg_fullnamefour"
						...
						value="<?php echo set_value('reg_fullnamefour');?>"><br> <label for="reg_emailfour" class="sr-only">E-Mail Address</label>
					<input type="text" name="reg_emailfour" id="reg_emailfour" class="form-control" placeholder="E-Mail Address"
						value="<?php echo set_value('reg_emailfour'); ?>"><br>
					...
					<label for="reg_fullnamefive" class="sr-only">Full Name</label> <input type="text" name="reg_fullnamefive"
						...
						value="<?php echo set_value('reg_fullnamefive');?>"><br> <label for="reg_emailfive" class="sr-only">E-Mail Address</label>
					<input type="text" name="reg_emailfive" id="reg_emailfive" class="form-control" placeholder="E-Mail Address"
						value="<?php echo set_value('reg_emailfive'); ?>"><br> <input type="submit" value="Create Users" name="reg_submit"
						id="reg_submit" class="btn btn-primary" style="margin-right: 24px"> <input type="reset" value="Reset Form"
						name="reg_reset" id="reg_reset" class="btn btn-secondary">
					    <?php echo form_close(); ?>
