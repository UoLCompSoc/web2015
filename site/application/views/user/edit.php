	...
	<div class="row text-center">
		...
		<div class="row">
			...
			<input id="userid" name="userid" type="hidden" value="<?php echo set_value('userid', $userid);?>" /> <label
					...
					value="<?php echo set_value('fullname', $fullname); ?>" /><br> <br> <label for="githubID" class="sr-only">GithubID:</label>
				...
				<input id="p_batch" name="p_batch" type="checkbox" value="1"
					<?php echo ($permissions['batch'] == 1 ? 'checked':''); ?>><br> <label for="p_clothing">Clothing Admin:</label> <input
					id="p_clothing" name="p_clothing" type="checkbox" value="1"
					<?php echo ($permissions['clothing'] == 1 ? 'checked':''); ?>><br> <label for="p_mailer">Batch Mailer Admin:</label>
				<input id="p_mailer" name="p_mailer" type="checkbox" value="1"
					<?php echo ($permissions['mailer'] == 1 ? 'checked':''); ?>><br> <input type="submit" value="Update" name="submit"
