				...
				<div class="panel panel-default">
					<div class="panel-body">
						<div class="page-header">
							...
							<p>
								<a href="/clothing/add">Add New Campaign</a>
							</p>
							<p>
								<a href="/clothing/sizelistview">View Clothing Sizes</a>
							</p>
						</div>
						<?php
						foreach ( $active as $campaign ) :
							?>
							<h3>
							<a href="/clothing/listview/<?php echo $campaign->id; ?>"><?php echo $campaign->name; ?></a>
						</h3>
						...
						<?php
						if (sizeof ( $expired ) == 0) {
							echo "<p>No expired campaigns found.</p>";
						} else {
