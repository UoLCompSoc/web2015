			...
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<?php echo form_open('login/register_process'); ?>
						...
						class="form-control" placeholder="E-Mail Address" value="<?php echo set_value('reg_email'); ?>"><br> <label
						for="reg_password1" class="sr-only">Password</label> <input type="password" name="reg_password1"
						id="reg_password1" class="form-control" placeholder="Password"><br> <label for="reg_password2" class="sr-only">Confirm
						password</label> <input type="password" name="reg_password2" id="reg_password2" class="form-control"
						placeholder="Confirm Password"><br> <input type="submit" value="Register" name="reg_submit" id="reg_submit"
					...
					<?php echo form_open('login/login_process'); ?>
						<label for="email" class="sr-only">E-mail Address</label> <input type="text" name="email" id="email"
						class="form-control" placeholder="E-Mail Address" value="<?php echo set_value('email'); ?>"><br> <label
						for="password" class="sr-only">Password</label> <input type="password" name="password" id="password"
						class="form-control" placeholder="Password"><br> <input type="submit" value="Login" name="submit" id="submit"
						class="btn btn-primary">
					<?php echo form_close(); ?>
