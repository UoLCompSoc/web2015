	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-12 text-center">
				...
				<input type="text" name="email" id="email" class="form-control" placeholder="E-Mail Address"><br>
		...
		<div class="row">
			<div class="col-lg-12 text-center">
				...
				<input type="text" name="reg_email" id="reg_email" class="form-control" placeholder="E-Mail Address"><br>
