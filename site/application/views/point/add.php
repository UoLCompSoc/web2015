...
<!-- Page Content -->
    ...
    <div class="row text-center">
		...
		<div class="row">
			...
			<label for="email" class="sr-only">Email:</label> <input id="email" name="email" type="text" class="form-control"
					placeholder="Email" value="<?php echo set_value('email', $email); ?>" /><br> <label for="amount" class="sr-only">Amount:</label>
				<input id="amount" name="amount" type="number" class="form-control" placeholder="Amount"
					value="<?php echo set_value('amount', $amount); ?>" /><br> <label for="pointtype" class="sr-only">Point Type:</label>
				<div class="controls">
